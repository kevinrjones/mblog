...
namespace MBlog.Controllers {
    public partial class CommentController {
        ...
        protected CommentController(Dummy d) : base(d) { }
        ...
        public class ActionParamsClass_Create {
            public readonly string commentViewModel = "commentViewModel";
        }
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_CommentController: MBlog.Controllers.CommentController {
        public T4MVC_CommentController() : base(Dummy.Instance) { }

        public override System.Web.Mvc.ActionResult Create(MBlog.Models.Comment.AddCommentViewModel commentViewModel) {
