...
namespace MBlogUnitTest.Domain
{
    ...
    public class MediaDomainTest
    {
        ...
        public void WhenExistingMediaIsRequested_ThenTheMediaIsReturned()
        {
            ...
            var media = mediaService.GetMedia(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<string>());
        ...
        {            
            ...
            Assert.Throws<MBlogMediaNotFoundException>(() => mediaService.GetMedia(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<string>()));            
        }
        ...
        public void WhenExistingMediaIsRequested_AndTheDataBaseIsNotAvailable_ThenAnMBlogExceptionIsThrown()
        {
            _mediaRepository.Setup(
                ...
                <Exception>();
            Assert.Throws<MBlogException>(() => mediaService.GetMedia(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<string>()));
        }
        ...
        public void WhenMediaIsCreated_ThenTheUrlToTheMediaIsReturned()
        {
            ...
            var url = mediaService.WriteMedia(Filename, It.IsAny<int>(), It.IsAny<string>(), stream.Object, It.IsAny<int>());
        ...
        public void WhenMediaIsCreated_AndTheDataBaseIsNotAvailable_ThenAnMBlogExceptionIsThrown()
        {
            ...
            Assert.Throws<MBlogException>(() => mediaService.WriteMedia(Filename, It.IsAny<int>(), It.IsAny<string>(), stream.Object, It.IsAny<int>()));
        }
        ...
        public void WhenMediaIsUpdated_ThenTheUpdatesAreWrittenToTheRepository()
        {
            ...
            mediaService.WriteMedia(Filename, "title", "caption", "description", "alternate", 1, "contenttype", (int)Media.ValidAllignments.Left, (int)Media.ValidSizes.Large, stream.Object, 2);
        ...
        public void WhenMediaIsUpdated_AndTheDataBaseIsNotAvailable_ThenAnMBlogExceptionIsThrown()
        {
            ...
            Assert.Throws<MBlogException>(() => mediaService.WriteMedia(Filename, It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<int>(), stream.Object, It.IsAny<int>()));
        }
        ...
        public void GivenAnExistingMedia_WhenDuplicateMediaIsCreated_ThenAnMBlogInsertItemExceptionIsThrown()
        {
            ...
            var stream = new Mock<Stream>();
            Assert.Throws<MBlogInsertItemException>(() => mediaService.WriteMedia(Filename, It.IsAny<int>(), It.IsAny<string>(), stream.Object, It.IsAny<int>()));
        }
        ...
        {
            _mediaRepository.Setup(m => m.GetMedia(It.IsAny<int>())).Returns(new Media { UserId = 1 });
            var media = mediaService.GetMedia(It.IsAny<int>(), 1);
            Assert.That(media, Is.Not.Null);
        }
        ...
        {
            _mediaRepository.Setup(m => m.GetMedia(It.IsAny<int>())).Throws<Exception>();
            Assert.Throws<MBlogException>(() => mediaService.UpdateMediaDetails(It.IsAny<int>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int>()));
        }
        ...
        public void WhenMediaIsUpdated_AndTheUserIsValid_AndTheDatabaseIsNotAvailable_ThenAnMBlogExceptionIsThrown()
        {
            ...
            Assert.Throws<MBlogException>(() => mediaService.UpdateMediaDetails(It.IsAny<int>(), "", It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), 1));
        }
        ...
        {
            _mediaRepository.Setup(m => m.GetMedia(It.IsAny<int>())).Returns(new Media { UserId = 1 });
            Assert.Throws<MBlogException>(() => mediaService.UpdateMediaDetails(It.IsAny<int>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), 2));
        }
        ...
        {
            _mediaRepository.Setup(m => m.GetMedia(It.IsAny<int>())).Returns(new Media { UserId = 1 });
            mediaService.UpdateMediaDetails(It.IsAny<int>(), "" , It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), 1);
