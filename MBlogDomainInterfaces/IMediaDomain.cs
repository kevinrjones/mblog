...
namespace MBlogDomainInterfaces
{
    public interface IMediaDomain
    {
        ...
        void WriteMedia(string fileName, string title, string caption, string description, string alternate, int userId, string contentType, int alignment, int size, Stream inputStream, int contentLength);
        Media UpdateMediaDetails(int id, string fileName, string caption, string description, string alternate, int userId);
    }
}
