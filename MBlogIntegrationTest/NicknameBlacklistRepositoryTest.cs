...
{
    [TestFixture]
    class NicknameBlacklistRepositoryTest
    {
        ...
        public void Setup()
        {
            ...
            _blacklistRepository = new NicknameBlacklistRepository(ConfigurationManager.ConnectionStrings["testdb"].ConnectionString);
