...
namespace MBlogIntegrationTest.Repositories
{
    ...
    public class MediaRepositoryTest
    {
        ...
        public void Setup()
        {
            ...
            {
                using (
                    var connection = new SqlConnection(ConfigurationManager.ConnectionStrings["mblog"].ConnectionString)
                    )
                {
        ...
        public void GivenAnExistingMedia_IfItIsUpdated_ThenTheMediaInTheDatabaseIsUpdated()
        {
            ...
            Media returnedMedia = _mediaRepository.Entities.Where(m => m.FileName == "filename_new").FirstOrDefault();
        ...
        {
            IEnumerable<Media> retrievedMedia = _mediaRepository.GetMedia(1, 2, _user.Id);
